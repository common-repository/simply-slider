 ...
 * Modified to be used with Themewerk_SimpleSlider
 */
jQuery(document).ready(function($){
 //hide actions
 jQuery('.delete-settings-image').hide();
 jQuery('.settings-image-action-visible').show();
 jQuery("img[src='']").hide();
 //on remove
 jQuery('.delete-settings-image').click(function(){
    $this= jQuery(this);
    ...
    var custom_uploader;
    jQuery('.settings-upload-image-button').click(function(e) {
        e.preventDefault();
        ...
        custom_uploader.on('select', function() {
           ...
           // console.log(attachment);
            jQuery('#'+get_id($this.data('id'))).val(attachment.url);
           //now update image
